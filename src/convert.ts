...
function inferArraySchema(p: Interface.Property, childProperties: JSONSchema4, additionalProperties: boolean, common: Object) {
...
function interfaceToJSONSchema(itf: Interface.Root, scope: Scope, additionalProperties: boolean): JSONSchema4 {
...
export default function convert(itf: Interface.Root, additionalProperties: boolean): Promise<Array<string>> {
    const reqJSONSchema = interfaceToJSONSchema(itf, 'request', additionalProperties)
    const resJSONSchema = interfaceToJSONSchema(itf, 'response', additionalProperties)
