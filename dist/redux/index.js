...
function getRequestTypesStr(interfaces) {
  return (
    'const RequestTypes:IRequestTypes = {\n        ' +
    interfaces
      .map(function(_a) {
        const modelName = _a.modelName;
        return (
...
function getRequestActionStr(interfaces) {
  return (
    'const RequestAction:IRequestAction = {\n        ' +
    interfaces
      .map(function(_a) {
        const id = _a.id,
    ...
    interfaces
      .map(function(_a) {
        ...
        return (
          ...
          modelName +
          "'](req)\n            return dispatchAction(action) as ResponsePromiseType<ModelItf['" +
          modelName +
          "']['Res']>\n        }"
        );
      })
    ...
    interfaces
      .map(function(_a) {
        ...
        return (
          ...
          "']['Req']\n            type Res = ModelItf['" +
          modelName +
          "']['Res']\n            type Item = IStoreItem['" +
          modelName +
          "']\n            return useResponseData<Req, Res, Item>('" +
          modelName +
          "', filter)\n        }"
        );
      })
    ...
    interfaces
      .map(function(_a) {
        ...
        return (
          ...
          modelName +
          "']) || []\n                return selectedState as ModelItf['" +
          modelName +
          "']['Res'][]\n            })\n        }"
        );
      })
