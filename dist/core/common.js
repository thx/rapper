...
function getInterfaces(rapUrl, projectId) {
  return __awaiter(this, void 0, void 0, function() {
    let response, data, modules, collaborators, interfaces, collaboratorsInterfaces;
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, axios_1['default'].get(rapUrl + '/repository/get?id=' + projectId)];
        case 1:
          response = _a.sent();
          ...
          return [
            4 /*yield*/,
            Promise.all(
              collaborators.map(function(e) {
                return getInterfaces(rapUrl, e.id);
              }),
            ),
          ];
        case 2:
                      ...
                      case 1:
                        ...
                        return [
                          ...
                          '\n            /**\n             * \u63A5\u53E3\u540D\uFF1A' +
                            ...
                            itf.modelName +
                            "': {\n              Req: " +
                            reqItf.replace('export interface Req', '') +
                            ';\n              Res: ' +
                            resItf.replace('export interface Res', '') +
                            ';\n            }\n          ',
                        ];
                      case 2:
                        error_1 = _b.sent();
                        throw chalk_1['default'].red(
                          '\u63A5\u53E3\uFF1Ahttp://rap2.alibaba-inc.com/repository/editor?id=' +
                            itf.repositoryId +
                            '&mod=' +
                            itf.moduleId +
                            '&itf=' +
