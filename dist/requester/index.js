...
function createRequestStr(interfaces, extr) {
  const projectId = extr.projectId,
    relModelPath = extr.relModelPath,
    relBaseFetchPath = extr.relBaseFetchPath;
  return (
    '\n          /**\n           * \u672C\u6587\u4EF6\u7531 Rapper \u4ECE Rap \u4E2D\u81EA\u52A8\u751F\u6210\uFF0C\u8BF7\u52FF\u4FEE\u6539\n           * Rap \u5730\u5740: http://rap2.alibaba-inc.com/repository/editor?id=' +
    projectId +
    "\n           */\n          import fetch from '" +
    relBaseFetchPath +
    "';\n          import { ModelItf } from '" +
    relModelPath +
    ...
    interfaces
      .map(function(itf) {
        ...
        return (
          ...
          "': (req: ModelItf['" +
          modelName +
          "']['Req'], extra: Extra) => {\n                return fetch<ModelItf['" +
          modelName +
          "']['Res']>('" +
          itf.url +
          "','" +
          itf.method.toUpperCase() +
          "', req, extra);\n              }"
        );
      })
      .join(',\n\n') +
