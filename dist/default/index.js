...
/** fetch.ts 文件的内容 */
function createFetch(interfaces, _a) {
    var projectId = _a.projectId, useCommonJsModule = _a.useCommonJsModule, optionalExtra = _a.optionalExtra, relModelPath = _a.relModelPath, relBaseFetchPath = _a.relBaseFetchPath;
    return "\n          /**\n           * \u672C\u6587\u4EF6\u7531 Rapper \u4ECE Rap \u4E2D\u81EA\u52A8\u751F\u6210\uFF0C\u8BF7\u52FF\u4FEE\u6539\n           * Rap \u5730\u5740: http://rap2.alibaba-inc.com/repository/editor?id=" + projectId + "\n           */\n        " + (useCommonJsModule
