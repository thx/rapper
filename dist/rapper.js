...
const base_fetch_1 = require('./core/base-fetch');
const runtime_1 = require('./redux/runtime');
const types_2 = require('./redux/types');
...
function default_1(_a) {
  let type = _a.type,
    ...
    _c = _a.rapperPath,
    rapperPath = _c === void 0 ? './rapper' : _c,
    _d = _a.urlMapper,
    urlMapper =
      _d === void 0
        ? function(t) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    let outputFiles, interfaces, e_1, Creator, modelStr;
        ...
        case 0:
          ...
          if (!type) {
            return [
              ...
              new Promise(function() {
                return console.log(chalk_1['default'].red('rapper: 请配置 type 参数'));
              }),
            ];
            ...
            return [
              2 /*return*/,
              new Promise(function() {
                return console.log(chalk_1['default'].red('rapper: type 参数配置错误，请重新配置'));
              }),
            ];
          }
          if (!projectId) {
            return [
              2 /*return*/,
              new Promise(function() {
                return console.log(chalk_1['default'].red('rapper: 请配置 projectId 参数'));
              }),
            ];
          }
          json_schema_to_typescript_1.DEFAULT_OPTIONS.style = __assign(
            {},
            json_schema_to_typescript_1.DEFAULT_OPTIONS.style,
            { singleQuote: true, semi: false, trailingComma: types_1.TRAILING_COMMA.ES5 },
          );
          ...
          if (!rapperPath) {
            return [
              2 /*return*/,
              new Promise(function() {
                return console.log(chalk_1['default'].red('rapper: rapperPath 配置失败，请修改'));
              }),
            ];
          } else {
        ...
        case 4:
          if (!(Array.isArray(interfaces) && interfaces.length)) {
            return [
              2 /*return*/,
              new Promise(function() {
                return console.log(chalk_1['default'].yellow('rapper: 没有课同步的 rap 接口'));
              }),
            ];
          }
          ...
          Creator.createIndexStr &&
            outputFiles.push({
              ...
              content: formatter_1.format(
                Creator.createIndexStr(projectId),
        ...
        case 5:
          ...
          Creator.createRequestStr &&
            outputFiles.push({
              ...
              content: formatter_1.format(
                Creator.createRequestStr(interfaces, { projectId: projectId }),
                json_schema_to_typescript_1.DEFAULT_OPTIONS,
              ),
            });
          /** 生成 base-fetch.ts */
